...
1. Obtain a build.  Either download the source of this repository and build the solution (src/PicasaWebSync.sln) or download the latest release from the [Releases](https://github.com/bradymholt/picasawebsync/releases) page.
